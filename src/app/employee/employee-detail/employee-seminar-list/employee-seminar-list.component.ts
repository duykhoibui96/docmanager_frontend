...
@Component({
  selector: 'app-employee-seminar-list',
  templateUrl: './employee-seminar-list.component.html',
  styleUrls: ['./employee-seminar-list.component.css']
})
export class EmployeeSeminarListComponent extends SearchUtility implements OnInit {
